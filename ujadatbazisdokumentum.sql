...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2016. Nov 21. 09:41
...
--
-- Tábla szerkezet ehhez a táblához `ujtabladokumentumpost`
--

CREATE TABLE `ujtabladokumentumpost` (
  `ID` int(11) NOT NULL,
  `Text` varchar(15000) COLLATE utf16_unicode_ci NOT NULL,
  `CreatonDate` date NOT NULL,
  `Likes` int(11) NOT NULL,
  `OwnerUser` varchar(40) COLLATE utf16_unicode_ci NOT NULL,
...
--
-- A tábla indexei `ujtabladokumentumpost`
--
ALTER TABLE `ujtabladokumentumpost`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT a táblához `ujtabladokumentumpost`
--
ALTER TABLE `ujtabladokumentumpost`
